...
async def run_polling_and_send_messages(context: ContextTypes.DEFAULT_TYPE):
...
def main():
    ...
    stop_pooling_handler = CommandHandler('stop_pooling', stop_pooling)
    button_handler = CallbackQueryHandler(button)

    app.add_handler(start_handler)
    app.add_handler(stop_pooling_handler)
